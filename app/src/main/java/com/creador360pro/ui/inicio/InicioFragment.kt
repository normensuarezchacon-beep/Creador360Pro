...
import com.creador360pro.ui.audio.AudioEditorActivity
import com.creador360pro.ui.editor.DesignEditorActivity
import com.creador360pro.ui.editor.VideoEditorActivity
import com.creador360pro.ui.teleprompter.TeleprompterActivity
...
class InicioFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        view.findViewById<View>(R.id.btnAudio).setOnClickListener {
            startActivity(Intent(requireContext(), AudioEditorActivity::class.java))
        }

        view.findViewById<View>(R.id.btnTeleprompter).setOnClickListener {
            startActivity(Intent(requireContext(), TeleprompterActivity::class.java))
        }
